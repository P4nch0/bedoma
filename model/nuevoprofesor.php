...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = 'INSERT INTO `profesor`(`idprofesor`, `nombre`, `apellido`, `contrasena`) 
            VALUES ( "'.$id.'",  "'.$nombre.'", "'.$ap.'", "'.$pwd.'" )';
    
    $try = mysqli_query($db,$sql);
    
    if($try === true) echo "<script>alert('Profesor creado exitosamente'); location.href='../index.php';</script>";
